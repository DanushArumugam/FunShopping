...
CREATE BIGFILE TABLESPACE tbs_perm_fsdb_01 DATAFILE 'D:\oracle\oradata\ORCL\tbs_perm_fsdb_01.dbf' SIZE 50M AUTOEXTEND ON; 
CREATE TEMPORARY TABLESPACE tbs_temp_fsdb_01 TEMPFILE 'D:\oracle\oradata\ORCL\tbs_temp_fsdb_01.dbf' SIZE 20M AUTOEXTEND ON; 
...
select * from sys.all_objects where owner = 'FSADMIN'; 
